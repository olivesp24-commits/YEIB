...
export function EntrepreneursCTA() {
  return (
    <section className="relative w-full py-32 md:py-48 flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        <h2 className="font-[var(--font-asul)] text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 drop-shadow-md">
          Not sure which instrument fits your business?
        </h2>
